    ...
    <v-container>
      <v-row>
        ...
        <v-col class="text-right">
          ...
          <div class="text-caption text-disabled" style="font-family: inherit;">
            &copy; 2024-{{ (new Date()).getFullYear() }} <span class="d-none d-sm-inline-block">Vuetify, Designer</span>
            —
            <a
